        ...
        public async Task<DataResponse> SaveAuditPlan([FromBody] audit_plan_save_dto dto)
        {
            try
            {
                ...
                using (var context = new ppa_entities())
                {
                    ...
                    entity.opening_meeting_start = dto.opening_meeting_start;
                    entity.opening_meeting_end = dto.opening_meeting_end;
                    entity.opening_meeting_venue = dto.opening_meeting_venue;

                    entity.closing_meeting_start = dto.closing_meeting_start;
                    entity.closing_meeting_end = dto.closing_meeting_end;
                    entity.closing_meeting_venue = dto.closing_meeting_venue;
        ...
        public async Task<DataResponse> SaveAudit([FromBody] audit_save_dto dto)
        {
            try
            {
                ...
                using (var context = new ppa_entities())
                {
                    ...
                    entity.location_id = (int)dto.location_id;
