    ...
    public class Exceptions
    {
        internal static Exception HandleDbUpdateException(DbUpdateException dbu)
        {
            ...
            try
            {
                ...
                {
                    builder.AppendFormat("INNER {0}", dbu.InnerException.Message);
                    if (dbu.InnerException.InnerException != null)
                        builder.AppendFormat("INNER2 {0}", dbu.InnerException.InnerException.Message);
                }
