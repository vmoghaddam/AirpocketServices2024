...
namespace ApiFDM.Controllers
{
    ...
    public class OstadController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/phase/cockpit/{y1}/{m1}/{y2}/{m2}")]
        public async Task<DataResponse> get_phase_cockpit(int y1, int m1,int y2,int m2)
        {
            ...
            try
            {
                ...
                var grp_phase_crew = (from x in main_source
                                       group x by new { x.Phase, x.Name,x.CrewId } into grp
                                       select new
                                       {
                ...
                var grp_phase_crew_ym = (from x in main_source
